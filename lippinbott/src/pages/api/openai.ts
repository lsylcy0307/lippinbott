...
export default async function handler(
  ...
  const userPrompt = "Help me find resources about Mississippi valley."
  ...
  try {
    const chatCompletion = await openai.chat.completions.create({
      model: "gpt-4-turbo",
      messages: [{"role": "user", "content": `I want you to ${userPrompt}. Give me a summary of the following page and how might it help with what I need: ${resource}`}], //summary for resource
    });
