...
export default async function handler(
  ...
  try {
    const chatCompletion = await openai.chat.completions.create({
      model: "gpt-4-turbo",
      messages: [{"role": "user", "content": `I want you to ${prompt}. Give me a summary of the following page and how might it help with what I need: ${resource}`}], //summary for resource
    });
